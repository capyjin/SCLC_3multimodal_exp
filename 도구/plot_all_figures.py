...
그림 하나당 함수 하나. 색 팔레트/rcParams 는 ``core.plotstyle`` 에서 가져오고
...
from core.plotstyle import (AQUA, BASE, BLUE, GREEN, GRID, INK, INK2, MAGENTA,
...
# 않고 여기 한 곳에서만 정의한다. 키는 core.model.MODALITY_CONFIGS 이름과 맞춤.
ABLATION_OS = {
